...
public class AccountsController {
  ...
  public ResponseEntity<Object> transferMoney(@RequestBody @Valid TransferRequest transferRequest) {
    log.info("Transferring money from account id:{} to account id: {}",transferRequest.getAccountFromId(),transferRequest.getAccountToId());
    try {
    ...
    }catch (AccountNotExistException | InsufficientBalanceException ex){
